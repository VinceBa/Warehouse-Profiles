...
#               and More profiles!
#               icons
#               Make profiles on the fly (no close the box)
#               Refresh select object select ouside the box
#               
...
class Profile:
   def __init__(self,obj,linksub,init_w,init_h,init_mt,init_ft,init_r1,init_r2,init_lenobj,init_wg,init_mf,init_hc,init_wc,type):
      ...
      obj.addProperty("App::PropertyFloat","BevelStart","Profile","Bevel on Y axle at the start of the profile").BevelStart = 0
      obj.addProperty("App::PropertyFloat","BevelEnd","Profile","Bevel on Y axle at the end of the profile").BevelEnd = 0
      obj.addProperty("App::PropertyFloat","BevelStartRotate","Profile","Rotate the cut on X axle at the start of the profile").BevelStartRotate = 0
      obj.addProperty("App::PropertyFloat","BevelEndRotate","Profile","Rotate the cut on X axle at the end of the profile").BevelEndRotate = 0
   ...
   def onChanged(self, obj, p):
      if p == "ProfileWidth" or p == "ProfileHeight" or p == "Thickness" \
         or p == "FilletRadius" or p == "BevelStart" or p == "BevelEnd" \
         or p == "BevelStartRotate" or p == "BevelEndRotate" \
         or p == "Centered" or p == "Length":
        self.execute(obj)
   ...
   def execute(self, obj):
        ...
        B1Y = obj.BevelStart
        B2Y = obj.BevelEnd
        B1X = -obj.BevelStartRotate
        B2X = obj.BevelEndRotate
            ...
            if B1Y or B2Y:                          
                ...
                if B1Y and not B2Y:
                    if obj.WidthCentered == False:          
                        ...
                        p3 = v(W+w,h,   -ZC1)
                        p4 = v(w,h,     -ZC1)
                        ProfileExt = ProfileFull.fuse(p.extrude(v(0,0,-ZC1)))
                    ...
                    if obj.WidthCentered == True:
                        if B1Y>0:
                            ...
                            p3 = v(w+W,h,   Z1Y/2-ZC1)
                            p4 = v(w,h,     Z1Y/2-ZC1)
                        ProfileExt = ProfileFull.fuse(p.extrude(v(0,0,-ZC1-Z1Y/2)))    
                        ProfileCut = ProfileExt.cut(self.SubtractiveCoinY(p1,p2,p3,p4,H,B1X,k))
                        obj.Shape  = ProfileCut.removeSplitter()
                ...
                if B2Y and not B1Y: 
                    if obj.WidthCentered == False: 
                        p1 = v(w,h,     L)
                        p2 = v(W+w,h,   L+Z2Y)
                        p3 = v(W+w,h,   L+Z2Y+ZC2)
                        p4 = v(w,h,     L+Z2Y+ZC2)
                        ProfileExt = ProfileFull.fuse(p.extrude(v(0,0,L+ZC2+Z2Y)))
                    ...
                    if obj.WidthCentered == True:
                        ...
                        ProfileExt = ProfileFull.fuse(p.extrude(v(0,0,L+Z2Y/2+ZC2)))
                        ProfileCut = ProfileExt.cut(self.SubtractiveCoinY(p1,p2,p3,p4,H,B2X,k))
                        obj.Shape  = ProfileCut.removeSplitter()
                ...
                if B1Y and B2Y :                  
                    if obj.WidthCentered == False: 
                        ...
                        p4 = v(w,h,     L+Z2Y+ZC2)
                        ProfileExt = ProfileFull.fuse(p.extrude(v(0,0,L+ZC2+Z2Y)))
                        ProfileCut1 = ProfileExt.cut(self.SubtractiveCoinY(p1,p2,p3,p4,H,B2X,k))
                        p1 = v(w,h,0)
                        p2 = v(W+w,h,   -Z1Y)
                        p3 = v(W+w,h,   -ZC1)
                        p4 = v(w,h,     -ZC1)
                        ProfileExt = ProfileCut1.fuse(p.extrude(v(0,0,-ZC1)))
                        ProfileCut2 = ProfileExt.cut(self.SubtractiveCoinY(p1,p2,p3,p4,H,B1X,k))
                    ...
                    if obj.WidthCentered == True:              
                        ...
                        if B1Y>0:
                            ...
                            p3 = v(w+W,h,   Z1Y/2-ZC1)
                            p4 = v(w,h,     Z1Y/2-ZC1)
                        ProfileExt = ProfileCut1.fuse(p.extrude(v(0,0,-ZC1-Z1Y/2)))    
                        ProfileCut2 = ProfileExt.cut(self.SubtractiveCoinY(p1,p2,p3,p4,H,B1X,k))
                        obj.Shape  = ProfileCut2.removeSplitter()   
            else: obj.Shape = ProfileFull
            
                # if wire2: obj.Shape = Part.Compound([wire1,wire2])  # OCC Sweep doesn't be able hollow shape yet :-(
                # else: obj.Shape = wire1
        else:
