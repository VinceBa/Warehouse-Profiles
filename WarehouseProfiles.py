...
#               choose the profile requested, adjust option and click OK
#               ->length and placement follow the edge
# manual:       Run the macro, adjust the option and click OK
...
# 23/01/2021 :  changed parameters for structure container
#               negative bevels are enable
#               changed the box layout
#               size give to name profile enable
#
# To do:        Bevels for centered profiles
#               T profiles
#               Aluminium profiles
#               and More profiles!
#               icons
#               improve the code and safety
...
class Box(QtGui.QDialog):
    ...
    def initUI(self,fam_init,size_init):
        ...
        newFont=QtGui.QFont(self.label_attach1.font())
        newFont.setPointSize(10)
        self.label_attach1.setFont(newFont)
        self.label_attach1.move (10, 250)
        try:
        ...
        newFont=QtGui.QFont(self.label_attach2.font())
        newFont.setPointSize(10)
        self.label_attach2.setFont(newFont)
        self.label_attach2.move (90, 250)
...
class Lprofile:
   def __init__(self,obj,linksub,init_w,init_h,init_mt,init_ft,init_r1,init_r2,init_lenobj,init_wg,init_mf,init_hw,init_hc,init_wc):
      ...
      obj.addProperty("App::PropertyFloat","Thickness","Profile").Thickness = init_mt
      ...
      obj.addProperty("App::PropertyFloat","Bevel1","Profile","First bevel cut").Bevel1 = 0
      obj.addProperty("App::PropertyFloat","Bevel2","Profile","Second bevel cut").Bevel2 = 0
      obj.addProperty("App::PropertyFloat","BevelRotate","Profile","Angle of bevel around his axle").BevelRotate = 0
      obj.addProperty("App::PropertyBool","MakeFillet","Profile","Wheter to draw the fillets or not").MakeFillet = init_mf
      obj.addProperty("App::PropertyBool","Hollow","Profile","Full or hollow").Hollow = init_hw
   ...
   def onChanged(self, obj, p):
      ...
      if p == "ProfileWidth" or p == "ProfileHeight" or p == "Thickness" or p == "FilletRadius" or p == "Bevel1" or p == "Bevel2" or p == "Centered" or p == "BevelRotate" or p == "Length":
        self.execute(obj)
...
class SQRprofile:
   ...
   def onChanged(self, obj, p):
      ...
      if p == "ProfileWidth" or p == "ProfileHeight" or p == "Thickness" or p == "FilletRadius" or p == "Length" or p == "Bevel1" or p == "Bevel2" or p == "Centered" or p == "BevelRotate":
        self.execute(obj)
...
class Uprofile:
   def __init__(self,obj,linksub,init_w,init_h,init_mt,init_ft,init_r1,init_r2,init_lenobj,init_wg,init_mf,init_hw,init_hc,init_wc,init_upn):
      ...
      obj.addProperty("App::PropertyFloat","MainThickness","Profile").MainThickness = init_mt
      obj.addProperty("App::PropertyFloat","FlangeThickness","Profile").FlangeThickness = init_ft
      ...
      obj.addProperty("App::PropertyBool","HeightCentered","Profile","Choose corner or profile centre as origin").HeightCentered = init_hc
      obj.addProperty("App::PropertyBool","WidthCentered","Profile","Choose corner or profile centre as origin").WidthCentered = init_wc
      obj.addProperty("App::PropertyBool","UPN","Profile","UPE style or UPN style").UPN = init_upn
   ...
   def onChanged(self, obj, p):
      ...
      if p == "ProfileWidth" or p == "ProfileHeight" or p == "MainThickness" or p == "FlangeThickness" or p == "FilletRadius" or p == "Length" or p == "Bevel1" or p == "Bevel2" or p == "BevelRotate":
        self.execute(obj)
...
class IHprofile:
   def __init__(self,obj,linksub,init_w,init_h,init_mt,init_ft,init_r1,init_r2,init_lenobj,init_wg,init_mf,init_hw,init_hc,init_wc,init_ipn):
      ...
      obj.addProperty("App::PropertyBool","IPN","Profile","IPE/HEA style or IPN style").IPN = init_ipn
      obj.addProperty("App::PropertyFloat","ApproxWeight","Base","").ApproxWeight= init_wg*init_lenobj  
   ...
   def onChanged(self, obj, p):
      ...
      if p == "ProfileWidth" or p == "ProfileHeight" or p == "FlangeThickness" or p == "MainThickness" or p == "FilletRadius" or p == "Length" or p == "Bevel1" or p == "Bevel2" or p == "BevelRotate":
        self.execute(obj)
...
class Pipe:
   ...
   def onChanged(self, obj, p):
      ...
      if p == "ProfileWidth" or p == "ProfileHeight" or p == "Thickness" or p == "Length" or p == "Bevel1" or p == "Bevel2" or p == "Centered" or p == "BevelRotate":
        self.execute(obj)
   ...
   def execute(self, obj):
        ...
        A2 = Part.makeCircle((H-TF)/2,c,d,0,360)       
        wire1 = Part.Wire([A1])
        wire2 = Part.Wire([A2])
